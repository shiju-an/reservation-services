...
class App extends React.Component {
  ...
  getFirstReservations(locationId) {
    $.ajax({
      method: 'GET',
      url: `https://ec2-52-53-223-116.us-west-1.compute.amazonaws.com:3000/location/${locationId}/reservations`,
      data: { id: locationId },
      success: (data) => {
  ...
  getLocation(locationId) {
    $.ajax({
      method: 'GET',
      url: `https://ec2-52-53-223-116.us-west-1.compute.amazonaws.com:3000/location/${locationId}`,
      data: { id: locationId },
      success: (res) => {
